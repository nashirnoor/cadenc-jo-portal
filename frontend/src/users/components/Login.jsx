                    ...
                    <div className='mt-8'>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='mt-8 flex flex-col gap-y-4'>
                                ...
                                <button className='active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all flex rounded-xl py-3 border-2 border-gray-200 items-center justify-center gap-2'>
